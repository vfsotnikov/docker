...
class FormHelper
{
    ...
    protected function attributes($attributes, $isMultiple, $valueAttribute = true) {
        ...
        // а его имени соответсвует элемент в массиве значений,
        ...
        foreach ($attributes as $k => $v) {
            ...
            // иначе k=v
                ...
                // квардратные скобки к его имени
    ...
    public function isOptionSelected($name, $value){
        // Если для аргументов $name в массиве отсутствует
        ...
        // находится значение аргумента $value в массиве
            ...
            return in_array($name, $this->values[$name]);
        }
